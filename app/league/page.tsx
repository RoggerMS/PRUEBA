...
const mockCompetitions = [
  {
    ...
    isJoined: true,
    isFeatured: true,
    organizer: { name: 'Departamento de Matemáticas', avatar: 'https://trae-api-us.mchost.guru/api/ide/v1/text_to_image?prompt=mathematics%20department%20logo&image_size=square' },
  ...
  },
  {
    ...
    isJoined: false,
    isFeatured: true,
    organizer: { name: 'Club de Programación', avatar: 'https://trae-api-us.mchost.guru/api/ide/v1/text_to_image?prompt=programming%20club%20logo&image_size=square' },
  ...
  },
  {
    ...
    isJoined: true,
    isFeatured: false,
    organizer: { name: 'Facultad de Ciencias', avatar: 'https://trae-api-us.mchost.guru/api/ide/v1/text_to_image?prompt=science%20faculty%20logo&image_size=square' },
  ...
  },
  {
    ...
    isJoined: false,
    isFeatured: false,
    organizer: { name: 'Departamento de Historia', avatar: 'https://trae-api-us.mchost.guru/api/ide/v1/text_to_image?prompt=history%20department%20logo&image_size=square' },
